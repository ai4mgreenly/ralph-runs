...
Ralph is a standalone agentic loop. You can copy it into your own project with minimal dependencies.
...
```bash
cp -r .claude/scripts/ralph /path/to/your/project/.claude/scripts/ralph
```
...
```bash
ln -s ../scripts/ralph/run /path/to/your/project/.claude/scripts/ralph
```
...
ln -s ../scripts/ralph/run /path/to/your/project/.claude/bin/ralph
```
...
- Run directly: `.claude/scripts/ralph/run --goal=...`
...
|-------------------|---------------|
| `.claude/scripts/ralph/` | `.claude/agents/ralph/` |
